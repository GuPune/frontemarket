<template>
  ...
  <div style="content">
    ...
    <Nav
      v-if="
        (currentRouteName != 'salepage-id' &&
          currentRouteName != 'salepage-id' &&
          currentRouteName != 'buy-slug' &&
          currentRouteName != 'buy-thankyou' &&
          currentRouteName != 'line' &&
          currentRouteName != 'line-id' &&
          currentRouteName == 'index') ||
        currentRouteName == 'cart-orderlist' ||
        currentRouteName == 'cart-comfirmorder' ||
        currentRouteName == 'cart-payment' ||
        currentRouteName == 'cart-success' ||
        currentRouteName == 'profile-historyorder' ||
        currentRouteName == 'find' ||
        currentRouteName == 'form-shopregis' ||
        currentRouteName == 'form-userregis' ||
        currentRouteName == 'id-product-productdetail-slug' ||
        currentRouteName == 'shoperror'
      "
    />
    <NavShop
      v-if="
        currentRouteName == 'id' ||
        currentRouteName == 'id-about' ||
        currentRouteName == 'id-new' ||
        currentRouteName == 'id-contact' ||
        currentRouteName == 'id-new-blogid'
      "
    />
    ...
    <div class="icon-bar">
      <a href="" class="facebook" @click="language('th')"
        ><img src="../assets/th.jpg" title="ไทย"
      /></a>

      <a href="" class="twitter" @click="language('en')"
        ><img src="../assets/en.jpg" title="อังกฤษ"
      /></a>
      <a href="" class="youtube" @click="language('ch')"
        ><img src="../assets/ch.png" title="จีน"
      /></a>
...
<nuxt-link v-if="$i18n.locale !== 'th'" :to="switchLocalePath('th')">ไทย</nuxt-link> -->
  ...
  <a href="#" class="youtube"><i class="fa fa-youtube"></i></a> -->
    ...
    <div>
      <button
        class="bt-top btn bt-top-line"
        onclick="window.open('https://page.line.me/?accountId=754jotpn','_blank')"
      >
        <svg
